...
var prize_descriptions = ['10 CASH', '50 COINS', '20 CASH', '100 CASH', '50 CASH', '100 CASH', 'MERCHANDIZE', '10 COINS'];
...
function drawSpinnerWheel() {
    ...
    if (canvas.getContext) {
        ...
        wheel.font = '16px bold Roboto, sans-serif';
        ...
        for (var i = 0; i < 8; i++) {
            ...
            wheel.rotate(angle + arc / 8 + Math.PI / 10);
            var text = prize_descriptions[i];
           
            // document.text[i].style.color = "green";
                    //  if (text != undefined) text = "Not this time!";
            wheel.fillText(text, -wheel.measureText(text).width/1.5,0);
            wheel.restore();
        }
